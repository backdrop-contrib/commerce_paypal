...
This project integrates Drupal Commerce with various PayPal payment solutions. The primary integration method is [PayPal Checkout](https://developer.paypal.com/docs/checkout/standard/), which supports payment via PayPal account, Pay Later, Venmo, and credit or debit card.
